...
sender_to_servo = {
    "10.42.0.102": {"pitch": 2, "roll": 4},  # Servo ID 2 -> pitch, Servo ID 4 -> roll
    "10.42.0.103": {"pitch": 3},
    "10.42.0.106": {"pitch": 6},
    "10.42.0.107": {"pitch": 7, "roll": 5}  # Servo ID 7 -> pitch, Servo ID 5 -> roll
}
